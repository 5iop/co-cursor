...
def test_short_trajectory():
    ...
    # 测试配置
    # α = path_ratio ∈ [1, +∞), α=1 为直线
    test_configs = [
        # (起点, 终点, alpha, effective_length, 描述)
        ((0.1, 0.1), (0.2, 0.2), 1.0, None, "短间距, α=1.0(直线), 无effective_length"),
        ((0.1, 0.1), (0.2, 0.2), 1.0, 50, "短间距, α=1.0(直线), m=50"),
        ((0.1, 0.1), (0.2, 0.2), 1.5, 100, "短间距, α=1.5, m=100"),
        ((0.1, 0.1), (0.5, 0.5), 2.0, 100, "中等间距, α=2.0, m=100"),
        ((0.1, 0.1), (0.9, 0.9), 3.0, None, "长间距, α=3.0(复杂), 无effective_length"),
    ]
